...
# Config: uefi + glibc + gnu + bash + dinit + pacman + lts + precompiled + gcc + zstd + modules + separate + gnu + compat + none + grub + off + ext4 + none + dhcpcd + password + none + selinux + hybrid
