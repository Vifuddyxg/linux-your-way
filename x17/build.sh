...
# Config: uefi + glibc + gnu + bash + dinit + xbps + lts + precompiled + gcc + zstd + modules + separate + gnu + compat + none + grub + off + ext4 + none + dhcpcd + password + sudo + selinux + hybrid
